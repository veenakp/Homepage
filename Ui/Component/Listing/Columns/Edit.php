            ...
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item['design_id'])) {
                    ...
                    if ($item['type']=='ContentBlock') {
                        $typeurl= 'homeblock/content/addnew';
                    } elseif ($item['type']=='ProductBlock') {
                        $typeurl= 'homeblock/product/addnew';
                    } elseif ($item['type']=='CustomBlock') {
                        $typeurl= 'homeblock/custom/addnew';
                    } elseif ($item['type']=='SliderBlock') {
                        $typeurl= 'homeblock/sliders/addnew';
                    }
